...
function openBadgesPage() {
    ...
    document.getElementById("badges-page").style.display = "inline";
}
function openHomePage() {
    document.getElementById("badges-page").style.display = "none";
...
function updateBadges(stats,winRate)
{
    ...
    if(winRate >= 60)
    {
        ...
        sixtyPercentWinRateBadge.style.textDecoration = "none";
    ...
    if(getTreeLevel(stats) === "Forest")
    {
        ...
        forestBadge.style.textDecoration = "none";
