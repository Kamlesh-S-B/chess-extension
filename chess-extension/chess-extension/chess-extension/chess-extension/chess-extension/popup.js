...
{
    // Get the Home and Badges pages
    let home = document.getElementById("home");
    let badges = document.getElementById("badges-page");

    // Start fading the Home page out
    home.style.opacity = 0;

    // Wait 300 milliseconds before running the code below
    setTimeout(function()
    {
        // Completely remove the Home page
        home.style.display = "none";

        // Show the Badges page
...
function updateBadges(stats,winRate)
{
    ...
    if(stats.all >= 1)
    {
        ...
        firstGameBadge.style.textDecoration = "none";
        document.getElementById("first-game-badge").textContent += " ✔"
    ...
    if(stats.all >= 20)
    {
        ...
        twentyGamesBadge.style.textDecoration = "none";
        document.getElementById("twenty-games-badge").textContent += " ✔"
    ...
    if(stats.all >= 75)
    {
        ...
        seventyFiveGamesBadge.style.textDecoration = "none";
        document.getElementById("seventy-five-games-badge").textContent += " ✔"
    ...
    if(stats.all >= 200)
    {
        ...
        twoHundredGamesBadge.style.textDecoration = "none";
        document.getElementById("two-hundred-games-badge").textContent += " ✔"
    ...
    if(stats.win >= 50)
    {
        ...
        fiftyWinsBadge.style.textDecoration = "none";
        document.getElementById("fifty-wins-badge").textContent += " ✔"
    ...
    if(winRate >= 60)
    {
        ...
        document.getElementById("sixty-percent-win-rate-badge").textContent += " ✔"
    ...
    if(getTreeLevel(stats) === "Forest")
    {
        ...
        document.getElementById("forest-badge").textContent += " ✔"
